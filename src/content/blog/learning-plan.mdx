...
* Differential Equations - [MIT OCW 18.03](https://ocw.mit.edu/courses/18-03sc-differential-equations-fall-2011/) **Up Next: Unit III: Convolution**

### Physics

* [Steve Brunton's playlist: Vector Calculus and Partial Differential Equations](https://www.youtube.com/playlist?list=PLMrJAkhIeNNQromC4WswpU1krLOq5Ro6S) **Up next: Helmholtz decomposition**
* Physics III - MIT OCW
...
#### Compilers
* Writing an interpreter in Go **Up next: Chapter 2 - Parsing**
...
* [CS183: Startup](https://www.youtube.com/playlist?list=PLU630Cd0ZQCMeQiSvU7DJmDJDitdE7m7r) **Up next: Lecture 14 - How to Operate**
* Inspired **COMPLETED**
...
* Death's End audiobook **Galaxy Era, Year 409 / Our Star**
