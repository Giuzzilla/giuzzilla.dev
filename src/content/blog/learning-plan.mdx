...
* Multivariable Calculus - [MIT OCW 18.02](https://ocw.mit.edu/courses/18-02-multivariable-calculus-fall-2007/) **Up Next: Lecture 5 - Parametric Equations**
* Hubbard & Hubbard - Vector Calculus, Linear Algebra, and Differential Forms **Up Next: Chapter 2**
...
* Databases - CMU
* Operating Systems - Three easy pieces book **Up Next: 12 A Dialogue on Memory Virtualization**
* Distributed Systems
* Compilers
...
* Children of Dune **COMPLETED**
* God Emperor of Dune **Up next: Chapter 1**
* The Hobbit **COMPLETED**
* The Fellowship of the Ring
* Why Greatness Cannot Be Planned book **Up next: Chapter 2**
