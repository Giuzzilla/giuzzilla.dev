...
* Physics II (Electromagnetism) - [MIT OCW 8.02](https://ocw.mit.edu/courses/8-02-physics-ii-electricity-and-magnetism-spring-2019/) **COMPLETED**
* Multivariable Calculus - [MIT OCW 18.02](https://ocw.mit.edu/courses/18-02-multivariable-calculus-fall-2007/) **COMPLETED**
* Differential Equations - [MIT OCW 18.03](https://ocw.mit.edu/courses/18-03sc-differential-equations-fall-2011/) **COMPLETED**
...
* Database Internals **Chapter 4 - Implementing B-Trees**
* Databases - CMU
* Operating Systems - Three easy pieces book **COMPLETED**
* Distributed Systems
...
* [A write-ahead log is not a universal part of durability](https://notes.eatonphil.com/2024-07-01-a-write-ahead-log-is-not-a-universal-part-of-durability.html) **COMPLETED**
...
* The Software Engineer's Guidebook by Gergely Orosz **COMPLETED**
* Observability Engineering **Chapter 12: Using Service-Level Objectives for Reliability**
...
* The Fellowship of the Ring **COMPLETED**
...
* The Dark Forest audiobook **COMPLETED**
* Death's End audiobook **COMPLETED**
* Hyperion audiobook **COMPLETED**
* Fall of Hyperion audiobook **COMPLETED**
* Foundation audiobook **COMPLETED**
* Foundation and Empire audiobook **COMPLETED**
* Second Foundation audiobook **COMPLETED**
* Foundation's Edge audiobook **COMPLETED**
* The End Of Eternity audiobook **COMPLETED**
* The Complete Robot audiobook **COMPLETED**
* The Caves of Steel audiobook **COMPLETED**
* The Naked Sun audiobook **Chapter 12: A target is missed**